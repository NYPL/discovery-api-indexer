...
function client () {
  if (!__client) {
    __client = new elasticsearch.Client({
      ...
      host: __connection_uri || config['elasticsearch'] || process.env['ELASTICSEARCH_HOST']
    })
  }
  return __client
}
...
var prepareResourcesIndex = (indexName, deleteIfExists) => {
  ...
  var common_properties = {
    ...
    contributorLiteral: { type: 'string', index: 'analyzed', fields: { raw: { type: 'string', 'index': 'not_analyzed' } } },
    ...
    creatorLiteral: { type: 'string', index: 'analyzed', fields: { raw: { type: 'string', 'index': 'not_analyzed' } } },
    creator_sort: {'type': 'string', 'index': 'not_analyzed'},
    ...
    deliveryLocation: genericEntityMapping,
    deliveryLocation_packed: {'type': 'string', 'index': 'not_analyzed'},
    holdingLocation: genericEntityMapping,
    holdingLocation_packed: {'type': 'string', 'index': 'not_analyzed'},
    ...
    subjectLiteral: { type: 'string', index: 'analyzed', fields: { raw: { type: 'string', 'index': 'not_analyzed' } } },
    status: genericEntityMapping,
    ...
    titleAlt: { 'type': 'string', 'index': 'analyzed' },
