          ...
          analysis: {
            ...
            analyzer: {
              ...
              ngram: {
                ...
                filter: [ 'lowercase', 'strip_punctuation_filter', 'icu_folding_filter', 'en_stop_filter', 'en_stem_filter' ],
                char_filter: [
              ...
              folding: {
                ...
                filter: [ 'lowercase', 'icu_folding_filter', 'en_stop_filter', 'en_stem_filter' ],
                char_filter: [
                  'extended_punctuation_char_filter'
                ]
              },
