...
var prepareResourcesIndex = (indexName, deleteIfExists) => {
  ...
  var common_properties = {
    ...
    items: {
      // TODO This should really be a `nested` type so that items are indexed independently of bibs per https://www.elastic.co/guide/en/elasticsearch/reference/current/nested.html
      type: 'object',
      properties: {
